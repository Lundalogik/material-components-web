...
```
npm install @lime-material-16px/grid-list
```
...
- Have 0.25rem padding in between themselves
...
The tile width is set to 12.5rem by default. There are three ways that you can
...
1. Using CSS variables
  ...
  ```css
  .mdc-grid-tile {
    --mdc-grid-list-tile-width: 18.75rem;
  }
  ```
...
2. Overwriting SCSS variable
  ...
  ```scss
  $mdc-grid-list-tile-width: 18.75rem;
  @import "@lime-material-16px/grid-list/mdc-grid-list";
  ```
...
Grid list tiles can have 0.0625rem padding instead of 0.25rem by adding
