...
```scss
@import "@limetech/mdc-p2-textfield/character-counter/mdc-text-field-character-counter";
```

### JavaScript Instantiation

```js
import {MDCTextFieldCharacterCounter} from '@limetech/mdc-p2-textfield/character-counter';
