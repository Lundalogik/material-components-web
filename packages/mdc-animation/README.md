...
```
npm install @lime-material-16px/animation
```
...
```scss
@import "@lime-material-16px/animation/variables";
...
```scss
@import "@lime-material-16px/animation/functions";
...
```js
import {getCorrectEventName} from '@lime-material-16px/animation';
