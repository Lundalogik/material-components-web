...
```
npm install @lime-material/animation
```
...
```scss
@import "@lime-material/animation/variables";
...
```scss
@import "@lime-material/animation/functions";
...
```js
import {getCorrectEventName} from '@lime-material/animation';
