...
```javascript
import {MDCTab, MDCTabFoundation} from '@limetech/mdc-tabs';
import {MDCTabBar, MDCTabBarFoundation} from '@limetech/mdc-tabs';
```

##### CommonJS

```javascript
const mdcTabs = require('@limetech/mdc-tabs');
...
```javascript
require(['path/to/@limetech/mdc-tabs'], mdcTabs => {
  const MDCTab = mdcTabs.MDCTab;
  const MDCTabFoundation = mdcTabs.MDCTabFoundation;
...
import {MDCTab, MDCTabFoundation} from '@limetech/mdc-tabs';
import {MDCTabBar, MDCTabBarFoundation} from '@limetech/mdc-tabs';
import {MDCTabBarScroller, MDCTabBarFoundationScroller} from '@limetech/mdc-tabs';
```
...
```javascript
import {MDCTabBarScroller, MDCTabBarScrollerFoundation} from '@limetech/mdc-tabs';
