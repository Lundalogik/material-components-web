...
```javascript
import {MDCPersistentDrawer, MDCPersistentDrawerFoundation, util} from '@lime-material/drawer';
```
...
```javascript
import {MDCPersistentDrawer} from '@lime-material/drawer';
...
```javascript
import {MDCTemporaryDrawer, MDCTemporaryDrawerFoundation, util} from '@lime-material/drawer';
```
...
```javascript
import {MDCTemporaryDrawer} from '@lime-material/drawer';
