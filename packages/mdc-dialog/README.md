...
```javascript
import {MDCDialog, MDCDialogFoundation, util} from '@lime-material/dialog';
```

##### CommonJS

```javascript
const mdcDialog = require('@lime-material/dialog');
...
```javascript
require(['path/to/@lime-material/dialog'], mdcDialog => {
