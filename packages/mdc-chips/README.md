...
```
npm install @lime-material-16px/chips
```
...
```scss
@import "@lime-material-16px/chips/mdc-chips";
```
...
To use the `MDCChip` and `MDCChipSet` classes, [import](../../docs/importing-js.md) both classes from `@lime-material-16px/chips`.
