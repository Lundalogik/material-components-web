...
```
npm install @lime-material-16px/toolbar
```
...
```javascript
import {MDCToolbar, MDCToolbarFoundation} from '@lime-material-16px/toolbar';
```

#### CommonJS

```javascript
const mdcToolbar = require('@lime-material-16px/toolbar');
...
```javascript
require(['/path/to/@lime-material-16px/toolbar'], mdcToolbar => {
  const MDCToolbar = mdcToolbar.MDCToolbar;
  const MDCToolbarFoundation = mdcToolbar.MDCToolbarFoundation;
});
```
...
```javascript
import {MDCToolbar} from '@lime-material-16px/toolbar';
