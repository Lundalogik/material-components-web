...
```
npm install @lime-material-16px/top-app-bar
```
...
```scss
@import "@lime-material-16px/top-app-bar/mdc-top-app-bar";
```

### JavaScript Instantiation

```js
import {MDCTopAppBar} from '@lime-material-16px/top-app-bar/index';
